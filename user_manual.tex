	...
	\subsection{Att använda kommandoradsgränsnittet}
		...
		\begin{table}[h!]
			...
			\begin{tabular}{p{0.2\linewidth}p{0.6\linewidth}}
				Flagga & Förklaring \\
				\hline
				\texttt{-h} & Skriver ut en hjälptext för 3DCopy i terminalen. \\
				\hline
				...
				\hline
				\texttt{-d} arg & Sätter maximum-correspondence-distance till värdet av arg. \\
				\hline
				\texttt{-i} arg & Sätter max-iterations till värdet av arg. \\
				\hline
				\texttt{-l} arg & Sätter log nivån till värdet av arg. (trace, debug, info, warn, error) \\
				\hline
