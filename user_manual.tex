...
\section{Inledning}
	\subsection{Parter}
	%% Skriv om alla inblandade i projektet här
	
	\subsection{Definitioner}
	%% Definitioner som används i dokumentet
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Mjukvara}
	%% Beskriv hur mjukvaran är uppbyggd  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\section{Grafiskt användargränsnitt}
	%% Skriv hur GUI:t är uppbyggt
	
\newpage 
  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%					Kommandoradsgränsnitt
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\section{Kommandoradsgränsnitt}
	%% Skriv hur Kommmandoradsgrännsnittet är uppbyggt
...
\section{Att använda systemet}
	%% Skriv om hur man använder systemet
